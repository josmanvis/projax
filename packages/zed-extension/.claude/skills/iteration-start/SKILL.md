...
description: Start a work iteration by analyzing beads issues, user prompts, and finding tasks to work on. Use at session start or when asked to begin work. Checks comments, screenshots, updates status, and picks ready tasks.
